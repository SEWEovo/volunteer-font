<template>
  <div id="publishStar">
    <div class="index">
      <div class="container">
        <div class="table-top">
          <span>{{new Date().getFullYear()}}年可获得星级志愿者名单</span>
        </div>
        <div class="btns">
          <el-button type class="btn" @click="pubilsh" :disabled="this.text=='已生成'">{{text}}</el-button>
        </div>
        <div class="table-container">
          <div class="main-table">
            ...
            >
              ...
              <el-table-column property="times" label="参与次数" v-if="this.text!='已生成'"></el-table-column>
              <el-table-column property="longTime" label="参与时长 " v-if="this.text!='已生成'"></el-table-column>
              <el-table-column property="score" label="总分" v-if="this.text!='已生成'"></el-table-column>
...
export default {
  ...
  // let time = new Date(Date.parse(new Date().getFullYear() + "-5-20"));
  // let now = new Date();
  // console.log(time)
  // console.log(now)
  // if (time == now) {
